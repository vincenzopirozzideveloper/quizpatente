...
class Dashboard extends Page
{
    ...
    protected function loadStats(): void
    {
        ...
        $ministerialQuizzes = MinisterialQuiz::active()
            ->has('questions', '=', 30)
            ->count();

        $completedMinisterialQuizzes = MinisterialQuiz::active()
            ->has('questions', '=', 30)
        ...
        $this->stats['ministerial_quizzes_total'] = $ministerialQuizzes;
        $this->stats['ministerial_quizzes_completed'] = $completedMinisterialQuizzes;
        $this->stats['ministerial_quizzes_progress'] = $ministerialQuizzes > 0
            ? round(($completedMinisterialQuizzes / $ministerialQuizzes) * 100)
            : 0;
    }

    protected function loadRecentTopics(): void
    {
        $this->recentTopics = Topic::with([
